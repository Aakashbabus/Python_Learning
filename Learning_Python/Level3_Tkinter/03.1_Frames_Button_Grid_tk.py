...
label = tk.Label(frame, text="Which Color do you Like?", font=("Helvetica", 14))

# Create buttons widget
button1 = tk.Button(frame, text="Blue", command=on_button_click1)
button2 = tk.Button(frame, text="Green", command=on_button_click2)
